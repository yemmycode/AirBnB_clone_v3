...
class TestBaseModelDocs(unittest.TestCase):
    """Class for testing documentation of the BaseModel"""
    ...
    def test_func_docstrings(self):
        """Test for the docstrings of all methods"""
...
class ConsoleTest(unittest.TestCase):
    """Class for testing the console commands"""
    ...
    def test_docstrings(self):
        """Test for the presence of docstrings in console methods"""
    ...
    def test_non_exist_command(self):
        """Test for handling non-existent commands"""
...
class CreateTest(unittest.TestCase):
    """Class for testing the create command in the console"""

    @classmethod
    def setUpClass(cls):
        """Set up for create command tests"""
        cls.console = HBNBCommand()
