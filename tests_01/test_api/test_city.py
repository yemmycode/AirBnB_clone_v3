...
class FlaskTestCase(unittest.TestCase):
    """Class for testing the Flask API"""
    data = {"name": "California"}

    @classmethod
    def setUpClass(cls):
        """Set up for the Flask API tests"""
        cls.app = app

    def test_post_method(self):
        """Test the POST method for /api/v1/states"""
    ...
    def test_get_method_by_id(self):
        """Test the GET method for /api/v1/states and related endpoints"""
        tester = app.test_client(self)
        response = tester.post('/api/v1/states', json=self.data)
        response = tester.post('/api/v1/states', json=self.data)
